...
image(x.mids, 1:42, act.runs[70,,] / act.runs[121,,], col=viridis(24), xlab='x position (m)', ylab='trial', main='', ylim=c(0, 42))
lines(x.mids, ratemaps.all[,70], col=viridis(3)[3], lwd=2)
axis(4, c(0, 5, 10), c(0, 5, 10))
mtext('firing rate (Hz)', 4, 2, adj=0)
image(x.mids, 1:42, act.runs[97,,] / act.runs[121,,], col=viridis(24), xlab='x position (m)', ylab='trial', main='', ylim=c(0, 42))
