...
6. The equilibrium potential is sometimes approximated as $\tilde{V} = \frac{g_\text{K}\,E_\text{K} + g_\text{Na}\,E_\text{Na}}{g_\text{K}+g_\text{Na}}$. Check the accuracy of the approximation and explain the difference! [4p]
