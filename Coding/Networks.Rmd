...
* Are there any computational or biological problems/challanges associated with it? Would it be easy to implement such a network with real, biological neurons? [4p]
