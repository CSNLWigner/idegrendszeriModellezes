...
Constant current is injected in a neuron of 20 um diameter with Hodgkin-Huxley channels. Try to change the injected current and find the AP threshold!

```{r}
I0 <- 0.05/1000 # change this to change the input current!
...
Short (2 ms) current pulse is injected in a neuron of 20 um diameter with Hodgkin-Huxley Na and K channels. Try to change the current pulse amplitude and find the AP threshold! Try also negative currents, or trains of pulses!
